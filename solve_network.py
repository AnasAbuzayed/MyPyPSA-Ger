...
def add_CCL_constraints(n, config):
    ...
    try:
        ...
        pass
    # p_nom_per_cc_g.to_excel('data/p_nom_per_cc_g.xlsx')
    # Storage_Unit
    # cc means country and carrier
    if any(n.storage_units.p_nom_extendable == True):
        p_nom_per_cc_s = (pd.DataFrame(
                        ...
                        .groupby(['carrier']).p_nom
                        .apply(join_exprs))
        # p_nom_per_cc_s.to_excel('data/p_nom_per_cc_s.xlsx')
    ...
    if any(n.stores.e_nom_extendable == True):
        ...
        # p_nom_per_cc_h.to_excel('data/p_nom_per_cc_h.xlsx')
    ...
    # p_nom_per_cc.to_excel('data/p_nom_per_cc.xlsx')
    ...
    if not maximum.empty:
        ...
        # maximum.loc[idxs].to_excel(f'data/maximum_cc{year}.xlsx')
        print(f'{year}: Applying Max CCL to',", ".join([str(i) for i in idxs]))
        # p_nom_per_cc.loc[idxs].to_excel('data/p_nom_per_cc_max.xlsx')
