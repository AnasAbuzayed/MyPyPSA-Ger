...
This module provides 'foundation' or 'setup' logic for your PyPSA model,
including folder creation, updating generator profiles, converting an
extendable network to a baseline (fixing certain capacities), and adding
hydrogen readiness.
"""
